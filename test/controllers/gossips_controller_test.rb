...
class GossipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gossip" do
    assert_difference('Gossip.count') do
      post gossips_url, params: { gossip: { anonymous_author: @gossip.anonymous_author, content: @gossip.content } }
    end
  ...
  test "should update gossip" do
    patch gossip_url(@gossip), params: { gossip: { anonymous_author: @gossip.anonymous_author, content: @gossip.content } }
